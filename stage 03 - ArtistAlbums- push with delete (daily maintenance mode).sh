...
#   2010-12-16, Dale Anderson
#   Rsync wrapper project for synchronizing my music library between work,
#   home, NAS, and server. See bottom of file for rsync options reference.
#   
#   Stage 3: Maintenance mode on work computer. (Pushes changes / deletions to main server).
#   
# --------------------------------------------------
