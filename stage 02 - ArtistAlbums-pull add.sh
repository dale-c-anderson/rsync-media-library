#!/bin/bash
# --------------------------------------------------
#   ArtistAlbums-pull.sh
#   2010-12-15, Dale Anderson
#   Part 2 of my Rsync wrapper project for synchronizing my music library between work,
...
logfile="./${remoteCatalogName}-pull.log"
passwordfile="./${remoteCatalogName}.secret"
exclusionsFile="./${remoteCatalogName}.exclusions"
source="${remoteUsername}@${remoteHost}::$remoteCatalogName/"
